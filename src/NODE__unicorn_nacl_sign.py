...
# --- BEGIN USER IMPORTS ---
import UNICORN_FILE_nacl_sign as unicorn_file
# --- END USER IMPORTS ---
...
class NODE__unicorn_nacl_sign:
	def __init__(self):
		self.__input_port_size = {}
		#Place Port Definitions Here
		# --- BEGIN USER PARAMS ---
		self.__input_port_size['default'] = 50
		self.__input_port_size['secret_key'] = 64
		self.__output_port_size = 50 + 64
		# --- END USER PARAMS ---
		
	
	def node_method(self, signal_in):
		if signal_in['default'] == None or signal_in['secret_key'] == None:
			return None
